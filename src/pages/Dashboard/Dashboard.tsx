      ...
      <div className="dashboard-container">
        ...
        <div className="absentees">
          ...
          <ol className="absentees_list" type="1">
            ...
            <li className="li-class">Hemath</li>
            <li className="li-class">Sai</li>
            <li className="li-class">Sudharsan</li>
            <li className="li-class">Prashiksha</li>
          </ol>
        </div>
